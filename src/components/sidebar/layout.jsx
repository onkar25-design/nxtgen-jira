...
const Layout = ({ sidebarOpen, setSidebarOpen, setCurrentPage, children }) => {
  return (
    <div className="flex h-screen">
      <Sidebar sidebarOpen={sidebarOpen} setSidebarOpen={setSidebarOpen} setCurrentPage={setCurrentPage} />
